...
public interface DemandReleaseDao {
    // 查询设备租赁信息数据dao接口
    public List<Equipment> queryEquipmentDao(@Param("keyWord") String keyWord, @Param("comp") String comp, @Param("uid") String uid, @Param("date") String date, @Param("page") int page) throws Exception;
    ...
    // 查询人才招聘信息数据dao接口
    public List<Recruit> queryRecruitDao(@Param("keyWord") String keyWord, @Param("comp") String comp, @Param("uid") String uid, @Param("tp") String tp, @Param("characters") String characters, @Param("date") String date, @Param("page") int page) throws Exception;
